# IaC scripts for deploying Kubespray PoC infra in AWS

## Overview

We are using [AWS CDK](https://aws.amazon.com/cdk/) to idempotently manage the lifecycles of the AWS resources needed for Kubespray-related PoC work such as EC2 instances, VPCs, security groups, etc.
